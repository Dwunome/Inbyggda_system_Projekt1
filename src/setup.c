...
static void init_GPIO(void)
{
	led1 = new_Led(9);	// I variabeln led1 lagras den instansierade struktmedlemmen self av datatypen struct Led. Variabeln led1 är global och har deklarerats i header.h.
